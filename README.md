...
Reference CLI: `skillerr` @ **0.9.9**, 164 tests passing on every push (mac/Linux/Windows × Node 22/24), including an [adversarial security corpus](./docs/THREAT-MODEL.md) and a live-tested [transparency-log integration](./docs/TRANSPARENCY.md).  
