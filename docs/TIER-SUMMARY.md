...
| PROTO-6: dangling `subskill`/`delegate` step kinds | RFC | `docs/rfcs/0004-dangling-step-kinds.md` |
...
| PROTO-8: media type + magic identification | RFC | `docs/rfcs/0005-media-type-magic-identification.md` |
| PROTO-9: lineage chain | RFC | `docs/rfcs/0006-lineage-chain.md` |
| PROTO-10: threat model | Code (doc) | `docs/THREAT-MODEL.md` |
